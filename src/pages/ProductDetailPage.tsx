            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    ...
                    <div className="space-y-3 mb-8 bg-gray-50 p-6 rounded-xl">
                      ...
                      <div className="flex items-center gap-3">
                        <Truck className="w-6 h-6 text-[#00FF00] flex-shrink-0" />
                        <span className="text-gray-700">Entrega em até 30 minutos</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <Shield className="w-6 h-6 text-[#00FF00] flex-shrink-0" />
                        <span className="text-gray-700">Certificado e seguro</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <Package className="w-6 h-6 text-[#00FF00] flex-shrink-0" />
                  ...
                  <div>
                    <Button
                      ...
                      className="w-full bg-[#00FF00] hover:bg-[#00DD00] text-white font-bold text-lg px-8 py-7 rounded-xl shadow-2xl hover:shadow-[#00FF00]/50 transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      <a
                    ...
                    <p className="text-center text-sm text-gray-500 mt-4">
                      💬 Resposta rápida garantida • 🚚 Entrega em Camaçari
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12 bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Marca</h3>
