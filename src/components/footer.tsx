...
import { CONTACT, BUSINESS, HOURS } from "@/config/constants";
          ...
          <div>
            ...
            <div className="space-y-3">
              <a 
                ...
                aria-label="Ligar para Gás Ideal"
              >
              ...
              <a 
                ...
                aria-label="Falar no WhatsApp com Gás Ideal"
              >
              ...
              <a 
                ...
                aria-label="Seguir Gás Ideal no Instagram"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400">{HOURS.weekdays}</p>
                <p className="mt-2">Domingos e Feriados</p>
                <p className="text-gray-400">{HOURS.weekends}</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 mt-1">{CONTACT.address.street}</p>
                <p className="text-gray-400">{CONTACT.address.neighborhood}</p>
                <p className="text-gray-400">{CONTACT.address.city} - {CONTACT.address.state}, {CONTACT.address.zipCode}</p>
                <a 
