...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#0000FF] shadow-lg">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          {/* WhatsApp Button - Unified for Desktop and Mobile */}
          <Button
            asChild
          ...
          >
            ...
            >
              ...
              <span className="hidden sm:inline">Peça no </span>
              <span>Whatsapp</span>
            </a>
          </Button>
        </div>
